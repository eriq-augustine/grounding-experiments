...
FROM
   ...
   SIMILAR_PREDICATE T_002
WHERE
   (T_000.partition_id IN (1,2))
   AND (T_001.partition_id IN (1,2))
   AND (T_002.partition_id IN (1,2))
   AND (T_001.UniqueStringID_1 = T_000.UniqueStringID_1)
   AND (T_002.UniqueStringID_0 = T_000.UniqueStringID_0)
   AND (T_002.UniqueStringID_1 = T_001.UniqueStringID_0)
